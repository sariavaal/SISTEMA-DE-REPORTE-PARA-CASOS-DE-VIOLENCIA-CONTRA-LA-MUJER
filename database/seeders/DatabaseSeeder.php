...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $iniciar_sesion_permiso = Permission::create(['name' => 'Iniciar sesion']);
        $editar_usuario_permiso = Permission::create(['name' => 'Editar usuarios']);
        ...
        $realizar_denuncia_permiso = Permission::create(['name' => 'Realizar denuncia']);
        ...
        $crear_denuncia_urgente_permiso = Permission::create(['name' => 'Crear denuncia urgente']);
        ...
        $user = User::create([
            'user_name' => 'Denunciante',
            'user_surname' =>'Denunciante',
            'user_ci' => '5689213',
            'user_email' => 'denunciante@gmail.com',
            'password' => Hash::make('admin123'),
